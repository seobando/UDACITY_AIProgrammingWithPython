...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        # Process the model_label to convert all characters within model_label 
        # to lowercase letters and then remove whitespace characters from the ends
        ...
        if truth in model_label:
            ...
            # and the value of 1 (where the value of 1 indicates a match between pet image 
        ...
        # the extend function 
            ...
            # Uses the extend list function to add the classifier label (model_label) 
            # and the value of 0 (where the value of 0 indicates NOT a match between the pet 
