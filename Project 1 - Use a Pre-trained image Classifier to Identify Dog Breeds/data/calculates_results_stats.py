...
def calculates_results_stats(results_dic):
    ...
    # Calculates the % of correctly matched images by the number of correctly 
    # matched images ('n_match') divided by the number of images('n_images'). 
    # This result is multiplied by 100.0 to provide the percentage.
    ...
    # Calculates the % of correctly classified dog images by the number of 
    # correctly classified dog images('n_correct_dogs') divided by the number 
    # of dog images('n_dogs_img'). This result is multiplied by 100.0 to provide 
    # the percentage.
    ...
    # Calculates the % of correctly classified breeds of dogs by the number of 
    # correctly classified breeds of dog('n_correct_breed') divided by the number 
    # of dog images('n_dogs_img'). This result is multiplied by 100.0 to provide 
    # the percentage.
    if results_stats_dic['n_dogs_img'] > 0:
