...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            # Classifier label can be comma-separated, so check each part
            classifier_label = results_dic[key][1]
            classifier_is_dog = 0
            
            # Split classifier label by comma and check each part
            classifier_parts = [part.strip() for part in classifier_label.split(',')]
            for part in classifier_parts:
                if part in dognames_dic:
                    classifier_is_dog = 1
                    break
